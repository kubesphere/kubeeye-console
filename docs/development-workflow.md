...
1. Visit https://github.com/kubesphere/kubeeye-console
...
mkdir -p $working_dir
cd $working_dir
git clone https://github.com/$user/kubeeye-console.git
cd $working_dir/kubeeye-console
git remote add upstream https://github.com/kubesphere/kubeeye-console.git
